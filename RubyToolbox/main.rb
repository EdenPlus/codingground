# This program is a toolbox [Version: Enhancement of Infinity]
...
case program
when "anagram"
    #This is an anagram solver [Version: Enhancement of Infinity]
    ...
    puts ("\nPlease hold...\n")
    arr = []
    (1..source.length).each{|i| source.permutation(i){|y| arr.push(y.join(""))}} #Change the number to make words of different lengths
    uniqueSortedArray = arr.uniq.sort_by{|x| x.length}
